-- ==============================================================================
-- Özerler Mermer ERP Platformu - Kapsamlı Test & Demo Veri Tohumlama Betiği
-- Realistic Enterprise Dummy Data Generator for Natural Stone Industry
-- ==============================================================================

SET FOREIGN_KEY_CHECKS = 0;

-- ------------------------------------------------------------------------------
-- 1. KULLANICILAR & ROLLER (Users & Roles)
-- ------------------------------------------------------------------------------
...
(4, 3), (4, 2), -- ocak_sefi -> ROLE_QUARRY_CHIEF, ROLE_USER
(5, 5), (5, 2), -- operator_ali -> ROLE_OPERATOR, ROLE_USER
(6, 6), (6, 2), -- atolye_sefi -> ROLE_WORKSHOP_CHIEF, ROLE_USER
(7, 8), (7, 2), -- muhasebe -> ROLE_FINANCE, ROLE_USER
(8, 10), (8, 2);-- kalite_uzmani -> ROLE_QC, ROLE_USER

-- ------------------------------------------------------------------------------
-- 2. OCAKLAR (Quarries)
-- ------------------------------------------------------------------------------
INSERT IGNORE INTO quarries (id, code, name, location, specific_gravity, license_no) VALUES
(1, 'Q-MUG-01', 'Yatağan Beyaz Ocağı', 'Muğla - Yatağan', 2.70, 'MUG-2024-884'),
...
(6, 2, 'BLK-2026-00130', '2026-09-04', 195, 320, 155, 9.672, 26307.00, 26100.00, -0.79, 'Afyon Bal', 'Koyu Bal Sarısı', 'EXTRA', 0, 'DEPOT', 58000.00, 8900.00, 66900.00, 'Birinci sınıf lüks otel lobisi için rezerve edildi.'),
...
(10, 1, 'BLK-2026-00134', '2026-09-08', 160, 260, 130, 5.408, 14601.00, 14200.00, -2.75, 'Muğla Beyaz', 'Koyu Gri Çizgili', 'C', 3, 'CUTTING', 24000.00, 5100.00, 29100.00, 'Yüksek kırık seviyesi; atölyede süpürgelik ve bordür ebatlamaya ayrıldı.');
...
(1, 'PAL-2026-00145', 'Ambar-A / Sehpa-04', 'EXPORT_CRATE', 'HASH-PAL-2026-00145-QR', 'PACKED', 4850.00),
...
-- ------------------------------------------------------------------------------
-- 5. FABRİKA KATRAK & KESİM İŞ EMİRLERİ (Production Orders)
-- ------------------------------------------------------------------------------
...
(1, 'PRD-2026-00452', 1, 'Katrak-01 (80 Lamalı)', 'GANGSAW', '2026-09-03 08:00:00', '2026-09-03 16:30:00', 8.50, 420.00, 1.20, 'Ahmet Kaya', 'COMPLETED', '48 plaka üretildi, kesim firesi FR-01 olarak kaydedildi.'),
...
-- ------------------------------------------------------------------------------
-- 6. FABRİKA PLAKALARI (Slabs - Quality Graded & Cost Multipliers)
-- ------------------------------------------------------------------------------
...
(1, 'SLB-2026-00851', 1, 1, 1, 2.00, 175.00, 285.00, 4.9875, 'POLISHED', 'A', 88, 1185.57, 'RESERVED'),
...
-- ------------------------------------------------------------------------------
-- 7. 10 NEDEN KODLU FİRE KAYITLARI (Scrap Logs: FR-01 .. FR-10)
-- ------------------------------------------------------------------------------
...
(3, 'SCRAP-2026-0003', 2, 2, NULL, 'FR-03', 380.00, 1.8500, 2100.00, 'Katrak hidrolik basınç dalgalanması sebebiyle gönye kaçması.', 'Ali Yıldız'),
(4, 'SCRAP-2026-0004', 1, 1, 3, 'FR-04', 210.00, 1.2000, 950.00, 'Vakumlu vantuz taşıyıcıdan sehpaya bırakırken köşe kırılması.', 'Ali Yıldız'),
(5, 'SCRAP-2026-0005', 3, 4, NULL, 'FR-05', 180.00, 0.9500, 820.00, 'Köprü kesme operatörü cetvel sıfırlama hatası.', 'Mustafa Yılmaz'),
(6, 'SCRAP-2026-0006', 4, 8, 12, 'FR-06', 320.00, 2.1000, 1650.00, 'Plaka gönyesinde 4 mm bombe oluşumu; kalınlık homojenliği bozuldu.', 'Deniz Arslan'),
(7, 'SCRAP-2026-0007', 2, 2, 7, 'FR-07', 150.00, 0.8000, 750.00, 'Cila hattı 4. abrasiv taş çizgi bıraktı; epoksi dolgu gerekti.', 'Serkan Özkan'),
(8, 'SCRAP-2026-0008', 4, 8, NULL, 'FR-08', 410.00, 2.3000, 1920.00, 'Aynı bloktan beklenmeyen koyu kahve damar geçişi; seleksiyon ayrımı yapıldı.', 'Deniz Arslan'),
(9, 'SCRAP-2026-0009', 1, 1, NULL, 'FR-09', 280.00, 1.5000, 1100.00, '80x120 kesimden artan üçgen ve kenar parçaları mozaik stokuna aktarıldı.', 'Mustafa Yılmaz'),
(10, 'SCRAP-2026-0010', NULL, NULL, NULL, 'FR-10', 520.00, 2.8000, 3400.00, 'Şantiye vinç indirmesinde palet çemberi gevşemesi sonucu kırım.', 'Mehmet Demir');

-- ------------------------------------------------------------------------------
-- 8. MİMARİ PROJELER & ŞANTİYELER (Projects & WBS)
-- ------------------------------------------------------------------------------
...
(1, 'PROJ-2026-0042', 'X Residence Lüks Konut Projesi', 'ABC İnşaat Yatırım A.Ş.', 12400000.00, 7800000.00, 8150000.00, '2026-08-01', '2027-04-30', 'ACTIVE', 'Lobi duvar kaplama, koridorlar ve ıslak hacimler doğal taş imalatı.'),
...
(1, 1, NULL, 'Zemin Kat Lobi & Karşılama', 'Zemin Kat', 'Muğla Beyaz 80x120 Cilalı', 1200.00, 850.00, 'IN_PROGRESS'),
(2, 1, NULL, '1-15 Tip Kat Koridorları', 'Kat 1-15', 'Burdur Bej 60x60 Honlu', 3500.00, 1200.00, 'IN_PROGRESS'),
(3, 1, NULL, 'Islak Hacimler (84 Daire)', 'Daire İçi', 'Afyon Şeker Özel CNC Alınlı', 840.00, 150.00, 'IN_PROGRESS'),
...
-- ------------------------------------------------------------------------------
-- 9. ATÖLYE KÖPRÜ KESME İŞ EMİRLERİ & PARÇALAR (Cut Orders & Items)
-- ------------------------------------------------------------------------------
...
(1, 'CUT-2026-00981', 1, 1, 'Köprü Kesme - CNC 01', 'Mustafa Yılmaz', '2026-09-04', 'COMPLETED', 'Lobi duvar kaplama için 80x120 cm ebatlı kesim.'),
...
(1, 'ITM-2026-00101', 1, 1, 80.00, 120.00, 2.00, 0.9600, 'PAHLI_CILALI', 1365.00, 'Lobi A Blok Kuzey Duvarı', 'READY'),
(2, 'ITM-2026-00102', 1, 1, 80.00, 120.00, 2.00, 0.9600, 'PAHLI_CILALI', 1365.00, 'Lobi A Blok Kuzey Duvarı', 'READY'),
(3, 'ITM-2026-00103', 1, 1, 80.00, 120.00, 2.00, 0.9600, 'PAHLI_CILALI', 1365.00, 'Lobi A Blok Güney Duvarı', 'READY'),
...
-- ------------------------------------------------------------------------------
-- 10. ŞANTİYE TÜKETİM & PUANTAJ SARFİYATLARI (Site Consumptions)
-- ------------------------------------------------------------------------------
...
(1, 1, 1, 'ADHESIVE', 'Yüksek Mukavemetli Granit/Mermer Yapıştırıcı', 400.00, 'TORBA', 220.00, 88000.00, 'Lobi zemin ve duvar montaj harcı'),
(2, 1, 1, 'LABOR', '1. Sınıf Mermer Montaj Ustası', 320.00, 'SAAT', 450.00, 144000.00, 'A Blok Lobi montaj işçilik puantajı'),
...
-- ------------------------------------------------------------------------------
-- 11. MALİYET MUHASEBESİ İŞLEMLERİ (Cost Transactions - ABC Allocation)
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 12. SEVKİYAT VE LOJİSTİK (Shipments)
-- ------------------------------------------------------------------------------
...
-- ==============================================================================
-- Tohumlama Tamamlandı (Seeding Completed Successfully)
-- ==============================================================================
