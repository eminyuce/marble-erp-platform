...
-- Realistic Enterprise Dummy Data Generator for Natural Stone Industry (PostgreSQL)
-- ==============================================================================

-- ------------------------------------------------------------------------------
-- 1. KULLANICILAR & ROLLER (Users & Roles)
-- ------------------------------------------------------------------------------
INSERT INTO users (id, username, email, password, first_name, last_name, enabled, deleted, created_at) VALUES
...
-- 2. OCAKLAR (Quarries)
-- ------------------------------------------------------------------------------
INSERT INTO quarries (id, code, name, location, specific_gravity, license_no) VALUES
...
INSERT INTO project_locations (id, project_id, parent_id, location_name, floor_level, stone_spec, planned_area_m2, installed_area_m2, status) VALUES
...
-- ------------------------------------------------------------------------------
INSERT INTO cut_orders (id, cut_order_no, project_id, location_id, machine_name, operator_name, planned_start, status, notes) VALUES
...
INSERT INTO cut_items (id, item_code, cut_order_id, source_slab_id, width_cm, length_cm, thickness_cm, area_m2, edge_finish, unit_cost, target_location, status) VALUES
...
-- ------------------------------------------------------------------------------
INSERT INTO site_consumptions (id, location_id, project_id, consumption_type, item_name, quantity, unit, unit_cost, total_cost, notes) VALUES
...
-- ------------------------------------------------------------------------------
INSERT INTO cost_transactions (id, center_id, block_id, slab_id, project_id, expense_type, amount, allocation_key, description) VALUES
...
-- ------------------------------------------------------------------------------
INSERT INTO shipments (id, waybill_no, project_id, vehicle_plate, driver_name, departure_time, distance_km, freight_cost, delivery_status) VALUES
