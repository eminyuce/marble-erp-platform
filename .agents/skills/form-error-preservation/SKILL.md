...
1. Show the failure as the page notice (`errorMessage` → `fragments/alerts.html`). Never send `IllegalArgumentException` or `RejectedInputException` to the developer error page.
