...
INSERT
IGNORE INTO users (id, username, email, password, first_name, last_name, enabled, deleted, created_at) VALUES
...
-- 2. EK OCAKLAR
INSERT
IGNORE INTO quarries (id, code, name, location, specific_gravity, license_no) VALUES
...
INSERT
IGNORE INTO blocks (id, quarry_id, block_code, extraction_date, width_cm, length_cm, height_cm, volume_m3, theoretical_weight_kg, actual_weight_kg, weight_deviation_pct, stone_type, color_tone, quality_grade, crack_level, status, extraction_cost, transport_cost, total_cost, notes) VALUES
...
-- 4. EK PALETLER
INSERT
IGNORE INTO pallets (id, pallet_code, warehouse_location, packaging_type, qr_code_hash, status, gross_weight_kg) VALUES
...
INSERT
IGNORE INTO production_orders (id, order_no, block_id, machine_name, process_type, start_time, end_time, duration_hours, electricity_kwh, blade_wear_mm, operator_name, status, notes) VALUES
...
-- 6. EK PLAKALAR
INSERT
IGNORE INTO slabs (id, slab_code, order_id, block_id, pallet_id, thickness_cm, width_cm, length_cm, surface_area_m2, surface_finish, quality_grade, gloss_level, cost_per_m2, status) VALUES
...
INSERT
IGNORE INTO scrap_logs (id, scrap_code, order_id, block_id, slab_id, reason_code, scrap_weight_kg, scrap_area_m2, cost_impact, description, logged_by) VALUES
...
INSERT
IGNORE INTO projects (id, project_code, name, customer_name, contract_value, estimated_cost, actual_cost, start_date, delivery_date, status, notes) VALUES
...
INSERT
IGNORE INTO project_locations (id, project_id, parent_id, location_name, floor_level, stone_spec, planned_area_m2, installed_area_m2, status) VALUES
...
INSERT
IGNORE INTO cut_orders (id, cut_order_no, project_id, location_id, machine_name, operator_name, planned_start, status, notes) VALUES
...
INSERT
IGNORE INTO cut_items (id, item_code, cut_order_id, source_slab_id, width_cm, length_cm, thickness_cm, area_m2, edge_finish, unit_cost, target_location, status) VALUES
...
INSERT
IGNORE INTO site_consumptions (id, location_id, project_id, consumption_type, item_name, quantity, unit, unit_cost, total_cost, notes) VALUES
...
INSERT
IGNORE INTO cost_transactions (id, center_id, block_id, slab_id, project_id, expense_type, amount, allocation_key, description) VALUES
...
-- 12. SEVKİYATLAR
INSERT
IGNORE INTO shipments (id, waybill_no, project_id, vehicle_plate, driver_name, departure_time, distance_km, freight_cost, delivery_status) VALUES
