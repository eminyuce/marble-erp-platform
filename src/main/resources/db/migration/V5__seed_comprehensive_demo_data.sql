...
(5, 'ocak_sefi', 'ocak@ozerler.com', '$2a$10$sdoBblM.8QEwHawmFd6qpuiLOPKNIG7se5maBAwcnQrcZGyM/1vsC', 'Osman', 'Güler', TRUE, FALSE, CURRENT_TIMESTAMP),
(6, 'operator_ali', 'ali.kaya@ozerler.com', '$2a$10$sdoBblM.8QEwHawmFd6qpuiLOPKNIG7se5maBAwcnQrcZGyM/1vsC', 'Ali', 'Yıldız', TRUE, FALSE, CURRENT_TIMESTAMP),
(7, 'atolye_sefi', 'atolye@ozerler.com', '$2a$10$sdoBblM.8QEwHawmFd6qpuiLOPKNIG7se5maBAwcnQrcZGyM/1vsC', 'Serkan', 'Özkan', TRUE, FALSE, CURRENT_TIMESTAMP),
(8, 'muhasebe', 'finans@ozerler.com', '$2a$10$sdoBblM.8QEwHawmFd6qpuiLOPKNIG7se5maBAwcnQrcZGyM/1vsC', 'Burcu', 'Çelik', TRUE, FALSE, CURRENT_TIMESTAMP),
(9, 'kalite_uzmani', 'kalite@ozerler.com', '$2a$10$sdoBblM.8QEwHawmFd6qpuiLOPKNIG7se5maBAwcnQrcZGyM/1vsC', 'Deniz', 'Arslan', TRUE, FALSE, CURRENT_TIMESTAMP)
