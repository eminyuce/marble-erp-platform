...
CREATE TABLE IF NOT EXISTS suppliers (
    ...
    supplier_type VARCHAR(50) NOT NULL DEFAULT 'CONSUMABLE',
    notes TEXT,
...
-- Seed demo suppliers
INSERT INTO suppliers (supplier_code, company_name, contact_person, phone, email, supplier_type) VALUES
('TED-001', 'Akçansa Çimento A.Ş.', 'Ali Vural', '0212-555-1234', 'satis@akcansa.com', 'CONSUMABLE'),
('TED-002', 'Betek Yapı Kimyasalları', 'Zeynep Ak', '0216-666-7890', 'siparis@betek.com', 'CHEMICAL'),
('TED-003', 'Kale Mermer Aletleri', 'Burak Taş', '0258-333-4567', 'info@kalealet.com', 'EQUIPMENT');
