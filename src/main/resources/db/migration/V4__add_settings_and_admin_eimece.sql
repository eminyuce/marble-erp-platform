...
(4, 'eimece_admin', 'admin@eimece.test', '$2a$10$8BFsneTqayq13mMdL6YkSunZo8CRlyNWZXAvbze.oHgRFSxtXMLHq', 'Eimece', 'Yönetici', TRUE, FALSE, CURRENT_TIMESTAMP);
...
('security.2fa.enabled', 'false', 'SECURITY', 'Tüm kullanıcılar için İki Adımlı Doğrulama (2FA) zorunluluğu'),
...
INSERT INTO email_templates (template_key, name, subject, body_html, placeholders) VALUES
('USER_WELCOME', 'Kullanıcı Hoş Geldiniz Bildirimi', 'Özerler Mermer ERP Sistemine Hoş Geldiniz', 
...
('DEFECT_QUARANTINE_ALERT', 'Kritik Mermer Çatlak Riski & Karantina', '🔴 ACİL ALARM: Blok Çatlak Riski Nedeniyle Karantina Kararı',
'<div style="font-family:sans-serif; padding:20px; color:#1e293b;">
...
('STOCK_SHORTAGE_WARNING', 'Proje Mahal Taş İhtiyaç Uyarısı', '🟠 UYARI: Şantiye İçin Taş Üretim Açığı Tespit Edildi',
'<div style="font-family:sans-serif; padding:20px; color:#1e293b;">
