...
(1, 'ROLE_ADMIN', 'Sistem Yöneticisi - Tam Yetki'),
...
(1, 'admin', 'admin@example.com', '$2a$10$sdoBblM.8QEwHawmFd6qpuiLOPKNIG7se5maBAwcnQrcZGyM/1vsC', 'Sistem', 'Yöneticisi', TRUE, FALSE, CURRENT_TIMESTAMP),
(2, 'factory_mgr', 'fabrika@ozerler.com', '$2a$10$sdoBblM.8QEwHawmFd6qpuiLOPKNIG7se5maBAwcnQrcZGyM/1vsC', 'Ahmet', 'Kaya', TRUE, FALSE, CURRENT_TIMESTAMP),
(3, 'site_chief', 'santiye@ozerler.com', '$2a$10$sdoBblM.8QEwHawmFd6qpuiLOPKNIG7se5maBAwcnQrcZGyM/1vsC', 'Mehmet', 'Demir', TRUE, FALSE, CURRENT_TIMESTAMP);
...
INSERT INTO cost_centers (id, code, name, monthly_budget, description) VALUES
(1, 'CC-001', 'Ocak & Çıkarma', 500000.00, 'Blok çıkarma, ayna amortismanı ve ocak direkt işçilik masrafları'),
...
(1, 1, 1, 'ADHESIVE', 'Yüksek Mukavemetli Granit Yapıştırıcı', 400.00, 'TORBA', 220.00, 88000.00, 'Lobi zemin ve duvar montaj harcı'),
